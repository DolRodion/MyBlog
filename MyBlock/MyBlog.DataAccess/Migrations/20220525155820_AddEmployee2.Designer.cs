...
namespace MyBlog.DataAccess.Migrations
{
    ...
    [Migration("20220525155820_AddEmployee2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBlog.DataAccess.Entities.AuthUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyBlog.DataAccess.Entities.AuthUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyBlog.DataAccess.Entities.Employee", b =>
                {
                    b.HasOne("MyBlog.DataAccess.Entities.AuthUser", "AuthUser")
                        .WithOne("Employee")
                        .HasForeignKey("MyBlog.DataAccess.Entities.Employee", "AuthUserId");
